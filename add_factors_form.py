...
insert_marker = '<div class="bg-white shadow-sm sm:rounded-2xl border border-slate-200 transition-all hover:shadow-md">'
if factors_html not in content:
    content = content.replace(insert_marker, factors_html + '\n        ' + insert_marker)
